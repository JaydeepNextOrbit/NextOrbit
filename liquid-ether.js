// LiquidEther Component - Vanilla JavaScript + Three.js Port from React Bits
// High-performance fluid dynamics simulation running in WebGL.
...
(function () {
  ...
  window.initLiquidEther = function (container, options = {}) {
    ...
    // Setup intersection observer to pause when offscreen
    const io = new IntersectionObserver(
      entries => {
        const entry = entries[0];
        const isVisible = entry.isIntersecting && entry.intersectionRatio > 0;
        webgl.isVisible = isVisible;
